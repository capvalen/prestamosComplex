...
$connectorBase1 = new WindowsPrintConnector("smb://127.0.0.1/XP-58");
try {
    ...
    //$printer -> text("Fecha límite Sábado, 4 Enero 2017. Posterior a ésta fecha el monto incrementará.\n");
		$printer -> text("Le atendió {$_POST['usuario']}\n");
		$printer->setJustification(Printer::JUSTIFY_CENTER);
    $printer -> text("****************\n");
    $printer -> text("Celular/ Whatsapp 943 xxxxx\n");
